   ...
   switch ( name[3] )
   {
      case 'a':
         ...
         if( !str_cmp( name, "do_advance" ) )
            return do_advance;
         if ( !str_cmp( name, "do_advancelevel"))
        	 return do_advancelevel;
      ...
      case 'm':
         ...
         if( !str_cmp( name, "do_makearmor" ) )
            return do_makearmor;
         if( !str_cmp( name, "do_makeblade" ) )
            return do_makeblade;
         if( !str_cmp( name, "do_makeblaster" ) )
            return do_makeblaster;
         if( !str_cmp( name, "do_makelightsaber" ) )
            return do_makelightsaber;
         ...
         if( !str_cmp( name, "do_mass_propeganda" ) )
            return do_mass_propeganda;
...
/*	if ( !str_cmp( name, "do_opentourney" ))	return do_opentourney; */
      ...
      case 'p':
         ...
         if( !str_cmp( name, "do_prompt" ) )
            return do_prompt;
         if( !str_cmp( name, "do_propeganda" ) )
            return do_propeganda;
      ...
      case 's':
         ...
         if( !str_cmp( name, "do_senate" ) )
            return do_senate;
         if( !str_cmp( name, "do_setblaster" ) )
            return do_setblaster;
...
char *skill_name( DO_FUN * skill )
{
   ...
   if( skill == do_smalltalk )
      return "do_smalltalk";
   if( skill == do_propeganda )
      return "do_propeganda";
   if( skill == do_bribe )
      return "do_bribe";
   if( skill == do_seduce )
      return "do_seduce";
   if( skill == do_mass_propeganda )
      return "do_mass_propeganda";
   if( skill == do_senate )
      return "do_senate";
...
*/ if( skill == do_gtell )
   ...
   if( skill == do_makeshield )
      return "do_makeshield";
   if( skill == do_makeblade )
      return "do_makeblade";
   if( skill == do_makeblaster )
      return "do_makeblaster";
   if( skill == do_makelightsaber )
      return "do_makelightsaber";
